...
experiment_name = "Time_Series_Forecasting_Model_TRAFFIC_FORECASTS_exp" # PLACEHOLDER
iteration = "32"  # PLACEHOLDER
run_id = "time_series_forecasting_model_traffic_forecasts_job_32"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/Time_Series_Forecasting_Model_TRAFFIC_FORECASTS_exp','subscription_id':'0a72ae34-da95-45b9-b3f1-f449a378177d','resource_group':'gbizz1-rg','workspace_name':'Workspace_Giacomo','iterations':1000,'primary_metric':'normalized_root_mean_squared_error','task_type':'regression','IsImageTask':False,'IsTextDNNTask':False,'n_cross_validations':3,'cv_step_size':None,'preprocess':True,'is_timeseries':True,'time_column_name':'Date','grain_column_names':None,'max_horizon':1460,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':1,'iteration_timeout_minutes':30,'enforce_time_on_windows':False,'experiment_timeout_minutes':120,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':None,'blacklist_models':None,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'minimize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'target_lags':'auto','window_size':'auto','target_rolling_window_size':'auto','is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_type':'Standard_DS3_v2','vm_priority':'dedicated','label_column_name':'Total_Traffic','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'time_series_id_column_names':None,'seasonality':'auto','short_series_handling_configuration':'auto','test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','verbosity':20,'ensemble_iterations':15,'ensemble_download_models_timeout_sec':300,'is_timeseries':True,'subscription_id':'0a72ae34-da95-45b9-b3f1-f449a378177d','time_column_name':'Date','grain_column_names':None,'max_horizon':1460}\",\"ensemble_run_id\":\"time_series_forecasting_model_traffic_forecasts_job_32\",\"experiment_name\":\"Time_Series_Forecasting_Model_TRAFFIC_FORECASTS_exp\",\"workspace_name\":\"Workspace_Giacomo\",\"subscription_id\":\"0a72ae34-da95-45b9-b3f1-f449a378177d\",\"resource_group_name\":\"gbizz1-rg\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/eastus2/workspaces/b295f816-a71f-4859-8578-f3b635b951cf/data/Traffic_timeseries/versions/1\",\"ResolvedUri\":\"azureml://locations/eastus2/workspaces/b295f816-a71f-4859-8578-f3b635b951cf/data/Traffic_timeseries/versions/1\",\"AssetId\":\"azureml://locations/eastus2/workspaces/b295f816-a71f-4859-8578-f3b635b951cf/data/Traffic_timeseries/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
